...
namespace toaaesmaielR.Controllers
{
    ...
    public class ValuesController : ControllerBase
    {
        ...
        public List<string> GetEmpById(string id)
        {
            ...
            string connectionString = "Data SourceDESKTOP-RJ8TBET;Initial Catalog=AdventureWorks2019;User ID=sa;Password=Tokamohamed; Integrated Security=true";
